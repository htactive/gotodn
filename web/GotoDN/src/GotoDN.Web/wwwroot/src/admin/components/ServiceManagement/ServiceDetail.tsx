...
interface thisProps {
  ...
  SaveHTService: (model: HTServiceModel) => void,
...
class HTServiceDetail extends React.Component<thisProps, {}> {
          ...
          <div className="col-lg-12 col-sm-12 form-horizontal">
            <div className="tabs mb20">
              <ul className="nav nav-tabs">
                {
                  this.props.SelectedHTService.HTServiceLanguages.map(x => <li
                    ...
                    <a onClick={() => this.props.ChangeSelectedLanguage(x.Language)}>
                      ...
                      {x.Language == LanguageEnums.Vietnamese ?
                        null : <a onClick={() => this.props.DeleteHTServiceLanguage
              ...
              <div className="tab-content">
                {
                  this.props.SelectedHTService.HTServiceLanguages.map(x => {
                    return <ServiceLanguageDetail IsSelected={x.Language == this.props.SelectedLanguage}
                                                   HTServiceLanguage={x}
  ...
  private saveHTService() {
    ...
    this.props.SaveHTService && this.props.SaveHTService(this.props.SelectedHTService);
  }
}
